		...
		<div class="container py-xl-4 py-lg-2">
			...
			Your cart
				...
				if(isset($_SESSION['dangnhap_home'])){
					echo '<p style="color:#000;">Hello: '.$_SESSION['dangnhap_home'].'<a href="index.php?quanly=giohang&dangxuat=1">Log Out</a></p>';
				}else{
					echo '';
				}
				?>
							...
							<div class="information-wrapper">
								<div class="first-row">
									<div class="controls form-group">
										<input class="billing-address-name form-control" type="text" name="name" placeholder="Fill in the name" required="">
									</div>
									...
									<div class="controls form-group">
										<select class="option-w3ls" name="giaohang">
											...
											<option value="1">ATM payment</option>
											<option value="0">Receive money at home</option>
								...
								?>
								<input type="submit" name="thanhtoan" class="btn btn-success" style="width: 20%" value="Pay">
