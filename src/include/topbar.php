<?php
	...
	if(isset($_POST['dangnhap_home'])) {
		...
		if($taikhoan=='' || $matkhau ==''){
			echo '<script>alert("Please do not leave it blank")</script>';
		}else{
			...
			if($count>0){
				...
				echo '<script>alert("Account password wrong")</script>';
			}
		}
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>" class="text-white">
								<i class="fas fa-truck mr-2"></i>View orders: <?php echo $_SESSION['dangnhap_home'] ?></a>
						</li>
						<?php
					}
						?>
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> 0397285159
						</li>
						<li class="text-center border-right text-white">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="#" method="post">
						...
						<p class="text-center dont-do mt-3">No account?
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" class="font-weight-bold font-italic">
							<img height="63px" src="https://static.ybox.vn/2022/7/3/1657082112733-Logo-Btec.png" alt=" ">  
						</a>
					</h1>
				</div>
				<!-- //logo -->
					...
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="index.php?quanly=timkiem" method="POST">
								<input class="form-control mr-sm-2" name="search_product" type="search" placeholder="Search product" aria-label="Search" required>
