...
<!-- top Products -->
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">view order</h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
								...
								<table class="table table-bordered ">
									...
									<tr>
										...
										if($row_donhang['tinhtrangdon']==0){
											...
											echo 'Processed | Delivery in progress';
										}
										?></td>
										<td>
											<?php
											...
											?>
											<a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>&magiaodich=<?php echo $row_donhang['magiaodich'] ?>&huydon=1">Cancellation request</a>
											<?php
										}elseif($row_donhang['huydon']==1){											
											?>
											<p>Waiting to cancel...</p>
											<?php
											}else{
												echo 'Đã hủy';
											}
