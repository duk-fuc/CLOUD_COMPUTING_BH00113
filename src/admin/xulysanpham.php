	  ...
	  <div class="collapse navbar-collapse" id="navbarNav">
	    <ul class="navbar-nav">
	      ...
	      <li class="nav-item">
	       ...
	       <li class="nav-item">
	        <a class="nav-link" href="xulydanhmucbaiviet.php">Categories Articles</a>
	      </li>
	         <li class="nav-item">
	        <a class="nav-link" href="xulybaiviet.php">Posts</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="xulysanpham.php">Products</a>
	      </li>
	       <li class="nav-item">
	        <a class="nav-link" href="xulykhachhang.php">Customers</a>
	      </li>
		...
		<?php
			if(isset($_GET['quanly'])=='capnhat'){
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="submit" name="capnhatsanpham" value="Product Update" class="btn btn-default">
				</form>
				</div>
			<?php
			}else{
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="submit" name="themsanpham" value="More products" class="btn btn-default">
				</form>
				</div>
				<?php
			} 
